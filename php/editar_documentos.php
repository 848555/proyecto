...
<head>
    ...
    <title>Actualizar de documentos</title>
    <link rel="stylesheet" href="/php/css/(registro documentos)style.css">
</head>
<script>
...
<body>
    ...
    <div class="contenedor"><br>
        <form class="col-3 p-3 m-auto" method="POST" action="/php/procesar/editar_docu.php" enctype="multipart/form-data">
        ...
        ?> </div>
            ...
            <a href="/php/inicio.php" class="btn2">CANCELAR</a>
            </form>
    </div>
